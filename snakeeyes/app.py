...
from snakeeyes.blueprints.standings import standings
from snakeeyes.blueprints.premier import premier
from snakeeyes.blueprints.upload import upload
...
def create_app(settings_override=None):
    ...
    app.register_blueprint(premier)
